...
author: Alison Hill & Paul Villanueva
output:
...
Use the linked Quarto docs to:

1. Add a [floating table of contents](https://quarto.org/docs/output-formats/html-basics.html#table-of-contents)
...
1. Add [code folding](https://quarto.org/docs/output-formats/html-code.html#folding-code)

**Render** to HTML to see the output.

**If this was all easy**, try adding a code tools: https://quarto.org/docs/output-formats/html-code.html#code-tools
